...
or to what extend trade offs have to be made due to inherent vulnerabilities.
Given that the protocol implemented by CWA resembles only the most basic
...
and the protocol of the Corona-virus warning app (Section \ref{sec:history}).
